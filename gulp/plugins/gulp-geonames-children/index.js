  ...
  function push(file, enc, cb) {
    ...
    try {
      geonames
        ...
        .then((response) => {
          let municipalitiesInVorpommernGreifswald = null;
          municipalitiesInVorpommernGreifswald = response;
          ...
          newfile.contents = new Buffer.from(
            JSON.stringify(municipalitiesInVorpommernGreifswald)
          );
          this.push(newfile);
          return cb(null);
        });
